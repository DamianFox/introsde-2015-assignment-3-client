 ...
 *       &lt;sequence>
 *         &lt;element name="MeasureDefinition" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadMeasureTypesResponse {
    ...
    protected List<String> measureDefinition;
     ...
     * 
     */
    public List<String> getMeasureDefinition() {
        if (measureDefinition == null) {
            measureDefinition = new ArrayList<String>();
        }
