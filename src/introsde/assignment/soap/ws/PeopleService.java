 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.soap.assignment.introsde/", wsdlLocation = "https://floating-bayou-5936.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://floating-bayou-5936.herokuapp.com/ws/people?wsdl");
